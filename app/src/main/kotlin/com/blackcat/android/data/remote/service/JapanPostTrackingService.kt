...
import com.blackcat.android.data.remote.parser.JapanPostHtmlParser
...
class JapanPostTrackingService @Inject constructor(
    private val client: OkHttpClient
) {
    companion object {
        private const val BASE_URL = "https://trackings.post.japanpost.jp/services/srv/search/direct"
    }

    suspend fun track(trackingNumber: String): TrackingResult = withContext(Dispatchers.IO) {
        try {
            val url = "$BASE_URL?reqCodeNo1=$trackingNumber&locale=ja"
            ...
            val statusList = JapanPostHtmlParser.parse(html)
